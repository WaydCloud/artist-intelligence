...
- **다음 액션**: ① **Phase C 착수 여부 = 도메인 소유자 결정**(A·B 완료 조건 충족. 기준선 3안 선택과 함께) ② A2 본편(케이스별 원형↔한국 서명 비교 — 데이터 확보됨) ③ 동시대 코호트 소급 구축 검토 ④ 스템 분리·신규 레그 승인 대기 ⑤ "2021 저지클럽 관측" 인터뷰 ⑥ 오늘 데일리 sonic 레그에서 av 재발 여부 확인.

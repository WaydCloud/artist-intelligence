...
그러므로 다음은 **대기 목록**(아래)에서 고르는 것이 자연스럽다 — 전부 "행"만 늘리는 작업이고 시각화 계약을 건드리지 않는다. 우선 후보: **A2 본편**(원형↔한국 서명 비교) · **sonic 축 후속**(사전 등록 필요) · **빌보드 궤적 → 임펄스 원장**.
